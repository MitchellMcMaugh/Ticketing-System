...
<div class="eventorganiser-event-meta">
	...
	<div class="eo-event-meta">
		...
		<?php if ( ! eo_recurs() ) { ?>
			<!-- Single event -->
			<h5><strong><?php esc_html_e( 'Date', 'eventorganiser' );?>:</strong> <?php echo eo_format_event_occurrence();?></h5>
		<?php } ?>
		...
		<?php if ( get_the_terms( get_the_ID(), 'event-category' ) ) { ?>
			<h5><strong><?php esc_html_e( 'In', 'eventorganiser' ); ?></strong> <?php echo get_the_term_list( get_the_ID(),'event-category', '', ', ', '' ); ?></h5>
		<?php } ?>
