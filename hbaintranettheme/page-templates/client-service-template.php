<?php
/**
 * Template Name: Client Service Template
 *
...
<div class="main-content">
	...
	<div class="lhs-menu">
		<?php if ( has_nav_menu( 'client-service-menu' ) || has_nav_menu( 'social' ) ) : ?>
			<div class="menu">
				<?php if ( has_nav_menu( 'client-service-menu' ) ) : ?>
					<?php
						wp_nav_menu( array(
							'theme_location' => 'client-service-menu',
							'menu_class'     => 'client-service-menu',
						 ) );
					?>
				<?php endif; ?>
			</div>
